...
notextile.. <p>Was this useful to you? Please consider donating some Bitcoins or Litecoins. Thanks!<br />
<script src="http://coinwidget.com/widget/coin.js"></script>
<script>
CoinWidgetCom.go({
	wallet_address: "1DXAFLsg4xnwdvkqQTJYCpsZvM5TRbdLUM"
	, currency: "bitcoin"
	, counter: "hide"
	, alignment: "bl"
	, qrcode: true
...
<script>
CoinWidgetCom.go({
	wallet_address: "LSwN9pDyVzGRfs2ibeauCLWwAwvhCDPc3a"
	, currency: "litecoin"
	, counter: "hide"
	, alignment: "bl"
	, qrcode: true
...
If this was useful to you in any way, please consider donating some Bitcoins (1DXAFLsg4xnwdvkqQTJYCpsZvM5TRbdLUM) or Litecoins (LSwN9pDyVzGRfs2ibeauCLWwAwvhCDPc3a). Thanks!
