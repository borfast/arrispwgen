...
# Use the "bookmarklet":http://borfast.github.com/arrispwgen/bookmarklet.js, on which you can click to obtain the password for the current day. As with any bookmarklet, you simply need to drag it into your browser's bookmarks and click on it whenever you want to use it.
